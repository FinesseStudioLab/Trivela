...
export const analytics = {
  ...
  trackWalletConnectSuccess: (provider, network, timeToConnectMs) =>
    trackEvent('wallet_connect_success', { provider, network, time_to_connect_ms: timeToConnectMs }),
  
  trackWalletConnectFailed: (provider, errorType, timeToFailureMs) =>
    trackEvent('wallet_connect_failed', { provider, error_type: errorType, time_to_failure_ms: timeToFailureMs }),
  
  // Registration
  trackRegistrationViewed: (campaignId, privacyMode, isRegistered, timeRemainingHours) =>
    trackEvent('registration_viewed', { campaign_id: campaignId, privacy_mode: privacyMode, is_registered: isRegistered, time_remaining_hours: timeRemainingHours }),
  
  trackRegistrationInitiated: (campaignId, privacyMode, hasAllowlistProof) =>
    trackEvent('registration_initiated', { campaign_id: campaignId, privacy_mode: privacyMode, has_allowlist_proof: hasAllowlistProof }),
  
  trackRegistrationTxSigned: (campaignId, privacyMode, timeToSignMs) =>
    trackEvent('registration_tx_signed', { campaign_id: campaignId, privacy_mode: privacyMode, time_to_sign_ms: timeToSignMs }),
  
  trackRegistrationSuccess: (campaignId, privacyMode, txFeeXlm, timeToConfirmMs, alreadyRegistered) =>
    trackEvent('registration_success', { campaign_id: campaignId, privacy_mode: privacyMode, tx_fee_xlm: txFeeXlm, time_to_confirm_ms: timeToConfirmMs, already_registered: alreadyRegistered }),
  
  trackRegistrationFailed: (campaignId, privacyMode, errorType, stage) =>
    trackEvent('registration_failed', { campaign_id: campaignId, privacy_mode: privacyMode, error_type: errorType, stage }),
  
  // Claim/Redeem
  trackRewardsViewed: (campaignId, balancePoints, hasPayoutAsset) =>
    trackEvent('rewards_viewed', { campaign_id: campaignId, balance_points: balancePoints, has_payout_asset: hasPayoutAsset }),
  
  trackClaimInitiated: (campaignId, claimType, amountRequested) =>
    trackEvent('claim_initiated', { campaign_id: campaignId, claim_type: claimType, amount_requested: amountRequested }),
  
  trackClaimTxSigned: (campaignId, claimType, timeToSignMs) =>
    trackEvent('claim_tx_signed', { campaign_id: campaignId, claim_type: claimType, time_to_sign_ms: timeToSignMs }),
  
  trackClaimSuccess: (campaignId, claimType, amountClaimed, txFeeXlm, timeToConfirmMs) =>
    trackEvent('claim_success', { campaign_id: campaignId, claim_type: claimType, amount_claimed: amountClaimed, tx_fee_xlm: txFeeXlm, time_to_confirm_ms: timeToConfirmMs }),
  
  trackClaimFailed: (campaignId, claimType, errorType, stage) =>
    trackEvent('claim_failed', { campaign_id: campaignId, claim_type: claimType, error_type: errorType, stage }),
  
  // Campaign discovery
  trackCampaignListViewed: (filterStatus, filterCategory, campaignsVisible) =>
    trackEvent('campaign_list_viewed', { filter_status: filterStatus, filter_category: filterCategory, campaigns_visible: campaignsVisible }),
  
  trackCampaignCardClicked: (campaignId, campaignStatus, position, sourcePage) =>
    trackEvent('campaign_card_clicked', { campaign_id: campaignId, campaign_status: campaignStatus, position, source_page: sourcePage }),
  
  trackCampaignDetailViewed: (campaignId, campaignStatus, hasPayoutAsset, privacyMode, daysRemaining) =>
    trackEvent('campaign_detail_viewed', { campaign_id: campaignId, campaign_status: campaignStatus, has_payout_asset: hasPayoutAsset, privacy_mode: privacyMode, days_remaining: daysRemaining }),
  
  // Campaign creation
  trackCampaignCreateStarted: (isAdmin, hasCreatedBefore) =>
    trackEvent('campaign_create_started', { is_admin: isAdmin, has_created_before: hasCreatedBefore }),
  
  trackCampaignCreateStepCompleted: (step, stepNumber, timeOnStepMs) =>
    trackEvent('campaign_create_step_completed', { step, step_number: stepNumber, time_on_step_ms: timeOnStepMs }),
  
  trackCampaignCreateSuccess: (campaignId, privacyMode, hasPayoutAsset, totalTimeMs, stepsVisited) =>
    trackEvent('campaign_create_success', { campaign_id: campaignId, privacy_mode: privacyMode, has_payout_asset: hasPayoutAsset, total_time_ms: totalTimeMs, steps_visited: stepsVisited }),
  ...
  trackSessionStarted: (entryPage, source, medium, campaign, referrerDomain) =>
    trackEvent('session_started', { entry_page: entryPage, source, medium, campaign, referrer_domain: referrerDomain }),
  
  trackPageViewed: (pagePath, pageTitle, previousPage) =>
    trackEvent('page_viewed', { page_path: pagePath, page_title: pageTitle, previous_page: previousPage }),
};
